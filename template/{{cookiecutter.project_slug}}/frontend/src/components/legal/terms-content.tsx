  ...
  return (
    <>
      <p>
        ...
        (the &ldquo;Service&rdquo;). By creating an account, accessing the Service, or
        clicking &ldquo;I agree,&rdquo; you accept these Terms.
      </p>
      <p>
      ...
      <p>
        ...
        under your account. Notify us at <a href="mailto:security@example.com">security@example.com</a>{" "}
      ...
      <ul>
        ...
        <li>Generate content that is illegal, harmful to minors, fraudulent, or designed to deceive;</li>
      ...
      <p>
        Paid plans renew automatically until canceled. Fees are non-refundable except where
        required by law. You can cancel anytime — your plan stays active until the end of the
      ...
      <p>
        The Service relies on third-party providers (e.g. model APIs, payment processors). Your
        use of those features is also subject to those providers&apos; terms. We don&apos;t
        control them and aren&apos;t responsible for their actions.
      </p>

      <h2>7. Intellectual property</h2>
      <p>
        We retain all rights to the Service, including software, designs, and trademarks. You
        retain all rights to your Customer Data and any output you generate using the Service,
        subject to applicable model providers&apos; terms.
      </p>

      <h2>8. Termination</h2>
      <p>
        You can stop using the Service at any time. We may suspend or terminate your access if
        you breach these Terms or for security reasons. Sections that should survive termination
        (IP, disclaimers, limitations of liability, dispute resolution) survive.
      </p>

      <h2>9. Disclaimers</h2>
      <p>
        The Service is provided &ldquo;as is.&rdquo; To the maximum extent permitted by law, we
        disclaim all warranties — express, implied, statutory — including merchantability,
        fitness for a particular purpose, and non-infringement.
      </p>
      <p>
        AI output may contain inaccuracies.{" "}
        <strong>
          Don&apos;t rely on the Service for advice in domains where mistakes have real
          consequences
        </strong>{" "}
      ...
      <p>
        We may update these Terms when the Service evolves. Material changes will be announced
        via email or in-app at least 30 days before they take effect. Continued use after the
      ...
      <p>
        ...
        registered, excluding conflict-of-law rules. Disputes go to the courts of that
        jurisdiction unless required otherwise by mandatory law.
      </p>

      <h2>13. Contact</h2>
      <p>
        Questions? Email <a href="mailto:legal@example.com">legal@example.com</a>. We respond
        within five business days for legal correspondence.
      </p>
    </>
  );
}
  ...
  return (
    <>
      <p>
        ...
        {APP_NAME} (&bdquo;Usługa&rdquo;). Zakładając konto, uzyskując dostęp do Usługi lub
        klikając &bdquo;Zgadzam się&rdquo;, akceptujesz ten Regulamin.
      </p>
      <p>
      ...
      <p>
        ...
        koncie. Powiadom nas na{" "}
        <a href="mailto:security@example.com">security@example.com</a> jeśli podejrzewasz, że
        konto zostało skompromitowane.
      </p>
      ...
      <ul>
        ...
        <li>
          sondować, skanować lub testować podatności Usługi bez wcześniejszej pisemnej zgody;
        </li>
      ...
      <p>
        Jesteś właścicielem tego, co wprowadzasz — promptów, dokumentów, treści rozmów
        (&bdquo;Dane Klienta&rdquo;). Udzielasz nam ograniczonej licencji na hostowanie,
        przetwarzanie i wyświetlanie Danych Klienta wyłącznie w celu obsługi Usługi dla Ciebie.
      </p>
      <p>
      ...
      <p>
        Kredyty wygasają na końcu każdego cyklu rozliczeniowego. Top-upy pay-as-you-go nie
        wygasają. Podatki są naliczane gdzie ma to zastosowanie.
      </p>

      <h2>6. Usługi stron trzecich</h2>
      <p>
        Usługa polega na dostawcach zewnętrznych (np. API modeli, procesorzy płatności).
        Korzystanie z tych funkcji podlega też regulaminom tych dostawców. Nie kontrolujemy ich i
        nie odpowiadamy za ich działania.
      </p>

      <h2>7. Własność intelektualna</h2>
      <p>
        Zachowujemy wszystkie prawa do Usługi, w tym oprogramowania, designu i znaków towarowych.
        Ty zachowujesz wszystkie prawa do swoich Danych Klienta i do output&apos;u, który generujesz
        za pomocą Usługi, z zastrzeżeniem regulaminów dostawców modeli.
      </p>
      ...
      <p>
        ...
        przetrwać wypowiedzenie (IP, wyłączenia odpowiedzialności, ograniczenia
        odpowiedzialności, rozstrzyganie sporów) przetrwają.
      </p>

      <h2>9. Wyłączenia odpowiedzialności</h2>
      <p>
        Usługa jest dostarczana &bdquo;tak jak jest&rdquo;. W maksymalnym zakresie dozwolonym
        prawem wyłączamy wszelkie gwarancje — wyrażone, dorozumiane, ustawowe — w tym
        merkantylność, przydatność do określonego celu i nienaruszalność.
      </p>
      <p>
      ...
      <p>
        ...
        wynikające lub związane z Usługą nie przekroczy większej z (a) kwoty, którą nam zapłaciłeś
        w ciągu 12 miesięcy przed roszczeniem lub (b) 100 USD. Żadna ze stron nie odpowiada za
        szkody pośrednie, przypadkowe, wynikowe lub karne.
      </p>
      ...
      <p>
        ...
        operacyjna, z wyłączeniem norm kolizyjnych. Spory rozstrzygają sądy tej jurysdykcji,
        chyba że bezwzględnie obowiązujące prawo stanowi inaczej.
      </p>

      <h2>13. Kontakt</h2>
      <p>
        Pytania? Napisz na <a href="mailto:legal@example.com">legal@example.com</a>. Odpowiadamy
        w ciągu pięciu dni roboczych dla korespondencji prawnej.
      </p>
    </>
  );
}
