        ...
        <div className="flex">
          <div className="bg-card border-foreground/10 max-w-[88%] rounded-2xl rounded-tl-sm border p-3">
            <div className="text-foreground/55 mb-1.5 flex items-center gap-1.5">
              ...
              <span className="font-mono text-[10px] uppercase tracking-wider">Assistant</span>
            </div>
...
function RagMockup({ className }: { className?: string }) {
  const RESULTS = [
    { title: "onboarding-feedback-q1.pdf", snippet: "...users struggled with the database setup step in 58% of cases...", score: 0.94 },
    { title: "support-tickets-march.md", snippet: "...repeatedly mentioned Stripe webhook configuration was unclear...", score: 0.87 },
    { title: "exit-survey-summary.docx", snippet: "...top reason for trial churn cited as missing example projects...", score: 0.82 },
  ];
  return (
    <MockFrame className={className}>
      <div className="p-4">
