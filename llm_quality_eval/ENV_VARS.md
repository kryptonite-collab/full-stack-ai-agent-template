...
Reference for `llm_quality_eval` runtime configuration. The
...
|---|---|---|---|
| `PROJECT_NAME` | optional | `llm_quality_eval` | Used in logs, OpenAPI title, email templates |
...
| Variable | Required | Default | Description |
|---|---|---|---|
| `DATABASE_URL` | optional | `sqlite:///./llm_quality_eval.db` | Local file path |
