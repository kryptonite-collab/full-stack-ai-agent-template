# Manual setup steps for llm_quality_eval
...
- [ ] Nothing to provision — file `llm_quality_eval.db` will be created on first run.
...
- [ ] (Optional) Ingest seed documents: `uv run llm_quality_eval rag-ingest /path/to/file.pdf --collection docs`.
