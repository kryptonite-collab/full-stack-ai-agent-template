...
Run with: `uv run llm_quality_eval cmd my-command --name test`
...
# Or use CLI
uv run llm_quality_eval db migrate -m "Add notifications table"
uv run llm_quality_eval db upgrade
```
