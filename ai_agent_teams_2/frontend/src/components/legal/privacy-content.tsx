...
export function PrivacyBodyEn() {
  return (
    <>
      ...
      <ul>
        <li><strong>Account info</strong> — name, email, hashed password, optional avatar.</li>
        <li>
      ...
      <ul>
        ...
        <li><strong>Cookies</strong> — see our <Link href="/legal/cookies">Cookie Policy</Link>.</li>
      </ul>
      ...
      <p>
        When you use AI features, your prompts and the relevant context are sent to our
        configured model providers (e.g. OpenAI, Anthropic, Google) for processing. We choose
        providers that contractually agree not to use your data for training.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          <strong>Authorities</strong> if required by law, but we&apos;ll push back where we can
          and notify affected users where legally permitted.
        </li>
        <li>
          <strong>An acquirer</strong> in the event of a merger or sale, with continuing
      ...
      <h2>10. Changes</h2>
      <p>
        We&apos;ll notify you in-app or via email before any material change takes effect.
...
export function PrivacyBodyPl() {
  return (
    <>
      ...
      <ul>
        <li><strong>Dane konta</strong> — imię, email, zhashowane hasło, opcjonalny avatar.</li>
        <li>
        ...
        <li><strong>Korespondencja ze wsparciem</strong> — gdy do nas piszesz.</li>
      </ul>
      ...
      <ul>
        ...
        <li>
          <strong>Organom</strong> jeśli wymaga tego prawo, ale walczymy gdzie możemy i
          powiadamiamy dotkniętych użytkowników gdzie jest to prawnie dozwolone.
        </li>
        <li>
      ...
      <h2>5. Retencja</h2>
      <p>
        Przechowujemy Dane Klienta tak długo jak konto jest aktywne. Po usunięciu konta backupy
        są usuwane w ciągu 30 dni. Logi i metryki są przechowywane do 90 dni dla bezpieczeństwa i
        analizy operacyjnej.
      </p>
      ...
      <p>
        ...
        przetwarzania. Napisz na <a href="mailto:privacy@example.com">privacy@example.com</a> by
        je zrealizować. Odpowiadamy w ciągu 30 dni.
      </p>

      <h2>7. Transfery międzynarodowe</h2>
      <p>
        Hostujemy głównie w UE. Tam, gdzie dane są przetwarzane poza Twoim krajem, opieramy się
        na standardowych klauzulach umownych lub równoważnych zabezpieczeniach.
      </p>
      ...
      <h2>10. Zmiany</h2>
      <p>
        Powiadomimy Cię w aplikacji lub mailem przed wejściem w życie jakichkolwiek istotnych
        zmian. Dalsze korzystanie po dacie wejścia w życie oznacza akceptację.
      </p>
