  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border-foreground/10 bg-card overflow-hidden rounded-2xl border">
        {/* Table head */}
        <div className="border-foreground/10 text-foreground/55 grid grid-cols-[1.6fr_0.8fr_0.6fr_0.6fr_0.4fr] items-center gap-3 border-b px-5 py-3 font-mono text-[10px] uppercase tracking-wider">
          <span>User</span>
          <span>Role</span>
          <span>Status</span>
          <span>Joined</span>
        ...
        {isLoading ? (
          ...
          <div className="p-5">
            <EmptyState
              ...
              description={
                search
                  ? `Nothing for "${search}". Try a different query.`
                  : "No users yet."
              }
            />
          </div>
          ...
          <ul className="divide-foreground/10 divide-y">
            {users.map((u) => (
              <li
                ...
                role="button"
                tabIndex={0}
                className="grid cursor-pointer grid-cols-[1.6fr_0.8fr_0.6fr_0.6fr_0.4fr] items-center gap-3 px-5 py-3 transition-colors hover:bg-foreground/[0.03]"
              >
                ...
                <div className="flex items-center gap-1.5">
                  <span className="font-mono text-foreground/70 text-[11px] uppercase tracking-wider">
                    {u.role}
                  </span>
                  {u.is_app_admin && (
                ...
                <span
                  className={cn(
                    "inline-flex w-fit items-center gap-1 rounded-full border px-2 py-0.5 font-mono text-[10px] font-semibold uppercase tracking-wider",
                    u.is_active
