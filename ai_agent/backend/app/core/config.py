...
class Settings(BaseSettings):
    ...
    # === Project ===
    PROJECT_NAME: str = "ai_agent_teams_2"
    ...
    LOGFIRE_SERVICE_NAME: str = "ai_agent_teams_2"
    ...
    POSTGRES_DB: str = "ai_agent_teams_2"
    ...
    # LiteParse — empty url means use bundled Tesseract.js OCR
    ...
    S3_RAG_BUCKET: str = "ai_agent_teams_2-rag"
    ...
    EMAIL_FROM: str = "noreply@ai_agent_teams_2.com"
    EMAIL_FROM_NAME: str = "ai_agent_teams_2"
    ...
    def rag(self) -> "RAGSettings":
        ...
        pdf_parser_kwargs: dict = {"method": self.PDF_PARSER}
        pdf_parser_kwargs["api_key"] = self.LLAMAPARSE_API_KEY
        pdf_parser_kwargs["tier"] = self.LLAMAPARSE_TIER
        pdf_parser_kwargs["liteparse_ocr_server_url"] = self.LITEPARSE_OCR_SERVER_URL or None
        pdf_parser_kwargs["liteparse_ocr_language"] = self.LITEPARSE_OCR_LANGUAGE
        pdf_parser_kwargs["liteparse_timeout_seconds"] = self.LITEPARSE_TIMEOUT_SECONDS
        pdf_parser = PdfParser(**pdf_parser_kwargs)
