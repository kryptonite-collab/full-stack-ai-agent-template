...
**ai_agent_3** - FastAPI application generated with [Full-Stack AI Agent Template](https://github.com/vstorm-co/full-stack-ai-agent-template).
...
# RAG
uv run ai_agent_3 rag-collections
uv run ai_agent_3 rag-ingest /path/to/file.pdf --collection docs
uv run ai_agent_3 rag-search "query" --collection docs
uv run ai_agent_3 rag-sync-gdrive --collection docs

# Sync Sources
uv run ai_agent_3 cmd rag-sources
uv run ai_agent_3 cmd rag-source-add
uv run ai_agent_3 cmd rag-source-sync
```
