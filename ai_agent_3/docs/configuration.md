...
|----------|---------|-------------|
| `PROJECT_NAME` | `ai_agent_3` | Display name for the project |
...
| `POSTGRES_DB` | `ai_agent_3` | Database name |
...
| `LOGFIRE_SERVICE_NAME` | `ai_agent_3` | Service name in Logfire dashboard |
