...
|----------|---------|-------------|
| `PROJECT_NAME` | `ai_agent_5` | Display name for the project |
...
| `POSTGRES_DB` | `ai_agent_5` | Database name |
...
| `LOGFIRE_SERVICE_NAME` | `ai_agent_5` | Service name in Logfire dashboard |
