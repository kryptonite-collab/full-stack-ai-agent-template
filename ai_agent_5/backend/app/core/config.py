...
class Settings(BaseSettings):
    ...
    LOGFIRE_SERVICE_NAME: str = "ai_agent_5"
    ...
    EMAIL_FROM: str = "noreply@ai_agent_5.com"
    EMAIL_FROM_NAME: str = "ai_agent_5"
