...
**ai_agent_5** - FastAPI application generated with [Full-Stack AI Agent Template](https://github.com/vstorm-co/full-stack-ai-agent-template).
...
# RAG
uv run ai_agent_5 rag-collections
uv run ai_agent_5 rag-ingest /path/to/file.pdf --collection docs
uv run ai_agent_5 rag-search "query" --collection docs

# Sync Sources
uv run ai_agent_5 cmd rag-sources
uv run ai_agent_5 cmd rag-source-add
uv run ai_agent_5 cmd rag-source-sync
```
